...
module WorkOS
  class DirectorySync
    ...
    def get_directory(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/directories/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
    ...
    def delete_directory(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/directories/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def get_group(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/directory_groups/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
    ...
    def get_user(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/directory_users/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
