...
module WorkOS
  class SSO
    ...
    def get_connection(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/connections/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
    ...
    def delete_connection(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/connections/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
