...
module WorkOS
  class Webhooks
    ...
    def update_webhook_endpoint(
      ...
      response = @client.execute_request(
        request: @client.patch_request(path: "/webhook_endpoints/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
      WorkOS::WebhookEndpointJson.new(response.body)
    end
    ...
    def delete_webhook_endpoint(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/webhook_endpoints/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
