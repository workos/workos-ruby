...
module WorkOS
  class OrganizationMembership
    ...
    # @param role [WorkOS::OrganizationMembership::RoleSingle, WorkOS::OrganizationMembership::RoleMultiple, nil] Identifies the role.
    # @param request_options [Hash] (see WorkOS::Types::RequestOptions)
    ...
    def create_organization_membership(
      ...
      if role
        case role
        when WorkOS::OrganizationMembership::RoleSingle
          body["role_slug"] = role.role_slug
        when WorkOS::OrganizationMembership::RoleMultiple
          body["role_slugs"] = role.role_slugs
        else
          raise ArgumentError, "expected role to be one of: WorkOS::OrganizationMembership::RoleSingle, WorkOS::OrganizationMembership::RoleMultiple, got #{role.class}"
        end
      end
      response = @client.request(
        method: :post,
