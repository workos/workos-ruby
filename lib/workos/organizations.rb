...
module WorkOS
  class Organizations
    ...
    def get_organization_by_external_id(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/organizations/external_id/#{CGI.escape(external_id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      WorkOS::Organization.new(response.body)
    end
    ...
    def get_organization(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/organizations/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      WorkOS::Organization.new(response.body)
    end
    ...
    def update_organization(
      ...
      response = @client.execute_request(
        request: @client.put_request(path: "/organizations/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
      WorkOS::Organization.new(response.body)
    end
    ...
    def delete_organization(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/organizations/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def get_audit_log_configuration(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/organizations/#{CGI.escape(id.to_s).gsub("+", "%20")}/audit_log_configuration", auth: true, request_options: request_options),
        request_options: request_options
      )
