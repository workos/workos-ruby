  ...
  class Radar
    ...
    def update_attempt(
      ...
      @client.execute_request(
        request: @client.put_request(path: "/radar/attempts/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def add_list_entry(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/radar/lists/#{CGI.escape(type.to_s).gsub("+", "%20")}/#{CGI.escape(action.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
    ...
    def remove_list_entry(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/radar/lists/#{CGI.escape(type.to_s).gsub("+", "%20")}/#{CGI.escape(action.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
      nil
    end
