  ...
  class Pipes
    ...
    def authorize_data_integration(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/data-integrations/#{CGI.escape(slug.to_s).gsub("+", "%20")}/authorize", auth: true, body: body, request_options: request_options),
    ...
    def create_data_integration_token(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/data-integrations/#{CGI.escape(slug.to_s).gsub("+", "%20")}/token", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
    ...
    def get_user_connected_account(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/user_management/users/#{CGI.escape(user_id.to_s).gsub("+", "%20")}/connected_accounts/#{CGI.escape(slug.to_s).gsub("+", "%20")}", auth: true, params: params, request_options: request_options),
        request_options: request_options
      )
    ...
    def delete_user_connected_account(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/user_management/users/#{CGI.escape(user_id.to_s).gsub("+", "%20")}/connected_accounts/#{CGI.escape(slug.to_s).gsub("+", "%20")}", auth: true, params: params, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def list_user_data_providers(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/user_management/users/#{CGI.escape(user_id.to_s).gsub("+", "%20")}/data_providers", auth: true, params: params, request_options: request_options),
        request_options: request_options
      )
