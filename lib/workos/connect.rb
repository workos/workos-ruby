...
module WorkOS
  class Connect
    ...
    def get_application(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/connect/applications/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      WorkOS::ConnectApplication.new(response.body)
    end
    ...
    def update_application(
      ...
      response = @client.execute_request(
        request: @client.put_request(path: "/connect/applications/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
      WorkOS::ConnectApplication.new(response.body)
    end
    ...
    def delete_application(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/connect/applications/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def list_application_client_secrets(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/connect/applications/#{CGI.escape(id.to_s).gsub("+", "%20")}/client_secrets", auth: true, request_options: request_options),
        request_options: request_options
      )
      parsed = JSON.parse(response.body)
    ...
    def create_application_client_secret(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/connect/applications/#{CGI.escape(id.to_s).gsub("+", "%20")}/client_secrets", auth: true, request_options: request_options),
        request_options: request_options
      )
    ...
    def delete_client_secret(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/connect/client_secrets/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
