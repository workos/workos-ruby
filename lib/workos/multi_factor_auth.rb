  ...
  class MultiFactorAuth
    ...
    def verify_challenge(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/auth/challenges/#{CGI.escape(id.to_s).gsub("+", "%20")}/verify", auth: true, body: body, request_options: request_options),
    ...
    def get_factor(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/auth/factors/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
    ...
    def delete_factor(
      ...
      @client.execute_request(
        request: @client.delete_request(path: "/auth/factors/#{CGI.escape(id.to_s).gsub("+", "%20")}", auth: true, request_options: request_options),
        request_options: request_options
      )
      nil
    end
    ...
    def challenge_factor(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/auth/factors/#{CGI.escape(id.to_s).gsub("+", "%20")}/challenge", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
    ...
    def list_user_auth_factors(
      ...
      response = @client.execute_request(
        request: @client.get_request(path: "/user_management/users/#{CGI.escape(userland_user_id.to_s).gsub("+", "%20")}/auth_factors", auth: true, params: params, request_options: request_options),
        request_options: request_options
      )
    ...
    def create_user_auth_factor(
      ...
      response = @client.execute_request(
        request: @client.post_request(path: "/user_management/users/#{CGI.escape(userland_user_id.to_s).gsub("+", "%20")}/auth_factors", auth: true, body: body, request_options: request_options),
        request_options: request_options
      )
