  ...
  class UserManagement
    ...
    def get_authorization_url(
      ...
      @client.execute_request(
        request: @client.get_request(path: "/user_management/authorize", auth: true, params: params)
      )
      nil
    end
    ...
    def get_logout_url(
      ...
      @client.execute_request(
        request: @client.get_request(path: "/user_management/sessions/logout", auth: true, params: params)
      )
      nil
    end
