...
class OrganizationMembershipTest < Minitest::Test
  ...
  def test_create_organization_membership_returns_expected_result
    ...
    result = @client.organization_membership.create_organization_membership(user_id: "stub", organization_id: "stub", role: WorkOS::OrganizationMembership::RoleSingle.new(role_slug: "stub"))
    refute_nil result
  end
  ...
  def test_create_organization_membership_with_role_multiple_returns_expected_result
    stub_request(:post, %r{\Ahttps://api\.workos\.com/user_management/organization_memberships(\?|\z)})
      ...
      .to_return(body: "{}", status: 200)
    result = @client.organization_membership.create_organization_membership(user_id: "stub", organization_id: "stub", role: WorkOS::OrganizationMembership::RoleMultiple.new(role_slugs: ["stub"]))
    refute_nil result
  end
  ...
  def test_update_organization_membership_returns_expected_result
    stub_request(:put, %r{\Ahttps://api\.workos\.com/user_management/organization_memberships/stub(\?|\z)})
      ...
      .to_return(body: "{}", status: 200)
    result = @client.organization_membership.update_organization_membership(id: "stub", role: WorkOS::OrganizationMembership::RoleSingle.new(role_slug: "stub"))
    refute_nil result
  end
  ...
  def test_update_organization_membership_with_role_multiple_returns_expected_result
    stub_request(:put, %r{\Ahttps://api\.workos\.com/user_management/organization_memberships/stub(\?|\z)})
      ...
      .to_return(body: "{}", status: 200)
    result = @client.organization_membership.update_organization_membership(id: "stub", role: WorkOS::OrganizationMembership::RoleMultiple.new(role_slugs: ["stub"]))
    refute_nil result
  end
  ...
  [
    ...
    {name: :create_organization_membership, verb: :post, url: %r{\Ahttps://api\.workos\.com/user_management/organization_memberships(\?|\z)}, args: {user_id: "stub", organization_id: "stub", role: WorkOS::OrganizationMembership::RoleSingle.new(role_slug: "stub")}},
    ...
    {name: :update_organization_membership, verb: :put, url: %r{\Ahttps://api\.workos\.com/user_management/organization_memberships/stub(\?|\z)}, args: {id: "stub", role: WorkOS::OrganizationMembership::RoleSingle.new(role_slug: "stub")}},
