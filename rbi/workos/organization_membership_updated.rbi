...
module WorkOS
  class OrganizationMembershipUpdated
    ...
    sig { returns(WorkOS::OrganizationMembershipUpdatedData) }
    def data; end

    sig { params(value: WorkOS::OrganizationMembershipUpdatedData).returns(WorkOS::OrganizationMembershipUpdatedData) }
    def data=(value); end
