...
module WorkOS
  class OrganizationMembershipDeleted
    ...
    sig { returns(WorkOS::OrganizationMembershipDeletedData) }
    def data; end

    sig { params(value: WorkOS::OrganizationMembershipDeletedData).returns(WorkOS::OrganizationMembershipDeletedData) }
    def data=(value); end
