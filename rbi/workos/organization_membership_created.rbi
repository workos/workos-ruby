...
module WorkOS
  class OrganizationMembershipCreated
    ...
    sig { returns(WorkOS::OrganizationMembershipCreatedData) }
    def data; end

    sig { params(value: WorkOS::OrganizationMembershipCreatedData).returns(WorkOS::OrganizationMembershipCreatedData) }
    def data=(value); end
