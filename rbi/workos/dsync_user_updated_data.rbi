...
module WorkOS
  class DsyncUserUpdatedData
    ...
    sig { params(value: T.nilable(T::Array[WorkOS::DsyncUserUpdatedDataEmail])).returns(T.nilable(T::Array[WorkOS::DsyncUserUpdatedDataEmail])) }
